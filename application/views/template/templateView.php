      ...
      <div class="collapse navbar-collapse" id="navbarHeadr">
        <ul class="navbar-nav mr-auto">
          <?php 
            ...
            {
              include "unauthorizedUsersMainMenu.php";
            }
            else
            {
...
<?php
  ...
  if(empty($_SESSION['Email']))
  {
    include "application/views/template/contentForUnauthorizedUsers.php";
  }
  else
  {
   include "application/views/template/contentForAuthorizedUsers.php";
  }
